\chapter[Limits of Entanglement]{What Entanglement Can and Cannot Do}
\label{chap:what-entanglement-can-and-cannot-do}

\begin{learningobjectives}
\begin{itemize}
  \item Compare local and joint data.
  \item Explain why each local result remains uncontrollable.
  \item Describe why classical communication is still needed in quantum teleportation.
\end{itemize}
\end{learningobjectives}

\begin{openingquestion}
Why do strong quantum correlations not permit faster-than-light messaging?
\end{openingquestion}

\paragraph{App and experiment mapping.}
Primary app material: \applevel{12}. Reproducible experiment IDs:
\experiment{EXP-ENT02, EXP-ENT03}.
